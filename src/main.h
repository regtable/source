...
#define START_MASTERNODE_PAYMENTS_TESTNET 1544067407
#define START_MASTERNODE_PAYMENTS 1559792207 // Human time (GMT): Thursday, June 6, 2019 3:36:47 AM

static const int64_t DARKSEND_COLLATERAL = (10000000*COIN); //10000
static const int64_t DARKSEND_FEE = (0.0001*COIN);
static const int64_t DARKSEND_POOL_MAX = (999999.99*COIN); //limit of 999999.99 DASH for a single mixing session only
static const int REWARD_START = 4;
static const int PREMINE_BLOCK = 4;
static const int FAIR_LAUNCH_BLOCK = 4;
static const int YEAR1_BLOCKS = 105120;
static const int YEAR2_BLOCKS = 315360;
...
static const int64_t MAX_MONEY = 6000000000 * COIN;
...
inline unsigned int GetTargetSpacing(int nHeight) { return IsProtocolV2(nHeight) ? 150 : 150; }
